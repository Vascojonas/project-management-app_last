    ...
    <div class=" ">
        ...
        <div class="row">
                        ...
                        despesas que garante a direcção e a fiscalização técnica da produção do estaleiro da obra.
                         ...
                         <div id="ri" class="form-group row mt-3">
                            <label  data-legenda="ri" for="riscos" class="col-md-6 col-form-label bg-secondary" style="height:36px;">Riscos (%)</label>
                             <div class="col-md-6">
                             <input class="form-control " onclick="riscosPop()"  type="NUMBER" id="riscos"  name="riscos" wire:model="taxa_riscos"
                             placeholder=" "  />
                             </div>
                         </div>
            ...
            <div class="d-flex justify-content-end p-0 ">
                ...
                <div class="form-group mt-3 row col-4 p-0 mr-1 ">
                    ...
                    @else
                       ...
                       <button wire:click="cadastrarCusto"  {{($actividadeValida)?'':'disabled '}} class="btn btn-secondary col-4 ml-auto mr-2" >Salvar</button>
                    @endif
                    
                    {{-- <button onclick="bloquearK(event)" type="button" class="btn btn-dark" ><i id="lock" class="fa-solid fa-lock-open"></i></button> --}}
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class=''>
                        ...
                        <p>
                            <strong>Despesa Inicial (% DI) </strong> é doa percentagem da despesa que a empresa incorre inicialmente Calculo custo indirecto(PLATAFORMA INFORMÁTICA)
                            antes de dar inicio aos trabalhos para a contratação pública.
                        </p>
                        
                        <ol class="pl-3" type="1">
                            <li class="">
                                Garantia Provisória - garantias que não pode ser superior a um vírgula cinco por
                                cento (1,5%) do valor estimado da contratação. <br>
                                <div class="d-flex justify-content-start">
                                    <img class="" src="{{ asset('imagens/legendas/di-1.png') }}" alt="" >
                                </div>
                            </li>

                            <li class="">
                                Garantia Definitiva – garantia que não pode exceder dez por cento (10%) do
                                valor da proposta da Contratada. <br>
                                <div class="d-flex justify-content-start">
                                    <img class="" src="{{ asset('imagens/legendas/di-2.png') }}" alt="" >
                                </div>
                            </li>

                            <li class="">
                                Garantia de Adiantamento – garantia que não deve exceder vinte por cento (20%)
                                do valor da adjudicação e a causa de pedir deve ter fundamento associado à
                                execução da obra. <br>
                                <div class="d-flex justify-content-start">
                                    <img class="" src="{{ asset('imagens/legendas/di-3.png') }}" alt="" >
                                </div>
                            </li>
                        </ol>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" onkeyup="calcularAl()"   class="form-control" id="al-cd">
                            </div>
                        </div>
                    ...
                    <div>
                        <p>
                           <strong> Administração Local (% AL) </strong> (estaleiro da obra) é a percentagem entendida como
despesas que garante a direcção e a fiscalização técnica da produção do estaleiro da obra.
                        </p>
                        <img src="{{ asset('imagens/legendas/al.png') }}" alt="" >
                    </div>
                </div>
                <div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div>
                        <p>
                            <strong> Administração central (% AC) </strong> é a percentagem da estrutura necessária para execução
                            das actividades de direção geral da empresa (áreas administrativa, financeira, contábil,
                            técnica, etc.)
                        </p>
                        <img src="{{ asset('imagens/legendas/ac.png') }}" alt="" style="">
                    </div>
                </div>
                <div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div>
                        <p>
                            <strong>Despesa Finaceira (%DF)</strong> é desafagem entre o momento de desembolso
                            e o momento de recebimento da medição, existe inevitavelmente uma perda monetária.
                            Caso o empreiteiro tenha recebido um adiantamento nos termos do n.º 3 do artigo 219 
                            do Decreto n.º 5/2016 de 8 de Março. Caso o empreiteiro receba o adiantamento, o custo financeiro é zero.
                        </p>
                        <img src="{{ asset('imagens/legendas/df.png') }}" alt="" >
                    </div>
                </div>
                <div>
